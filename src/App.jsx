...
function App() {
  ...
  // Automatically create a room on load
  async function createRoomIfNone() {
    try {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-zinc-900 via-black to-zinc-800 text-white flex flex-col items-center py-10 px-4 relative overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-full z-0">
        <div className="w-64 h-64 bg-pink-500 blur-[160px] opacity-30 absolute -top-20 -left-20 rounded-full pointer-events-none" />
        <div className="w-64 h-64 bg-orange-400 blur-[140px] opacity-20 absolute top-40 right-10 rounded-full pointer-events-none" />
      </div>
